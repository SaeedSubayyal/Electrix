    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($requestData["functionname"]) && $requestData["functionname"] === "AdminSignUp") {
            ...
            if (!empty($Name) && !empty($Email) && !empty($Password)) {
                ...
                try {
                    $SQL = "INSERT INTO admin(admin_name, admin_email, admin_password,admin_cnic,admin_phonenum,admin_address) VALUES ('$Name', '$Email', '$password_hash', '$CNIC', '$PhoneNum', '$Address')";
                    mysqli_query($conn, $SQL);      
                    // require "vendor/autoload.php";
                    // require 'C:/xampp/htdocs/electrix/phpserver/PHPMailer.php';
                    // require 'C:/xampp/htdocs/electrix/phpserver/Exception.php';
                    // require 'C:/xampp/htdocs/electrix/phpserver/SMTP.php';  
