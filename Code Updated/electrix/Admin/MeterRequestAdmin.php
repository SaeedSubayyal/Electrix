...
<head>
    ...
    <title>Meter Requests</title>
    <link href='https://unpkg.com/boxicons@2.0.9/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="MeterRequestsAdmin.css">
...
<nav>
        ...
        <div class="sidebar-links">
            <ul>
                ...
                <li class="tooltip-element" data-tooltip="1">
                    <a href="MeterRequestsAdmin.php" data-active="1">
                        <div class="icon">
                ...
                <li class="tooltip-element" data-tooltip="2">
                    <a href="RegisterEmployeeAdmin.html" data-active="2">
                        <div class="icon">
                ...
                <li class="tooltip-element" data-tooltip="3">
                    <a href="FeedbackAdmin.html" data-active="3">
                        <div class="icon">
    ...
    <main>
        <h1>Meter Requests</h1>
        <h3 class = "Formprompt">User Requests:<br></h3>
 ...
 <div class="row">
  ...
  <?php
    ...
    ?>
      ...
      <td><?php echo $data['Date_Requested']??''; ?></td>
